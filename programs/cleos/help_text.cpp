/**
 *  @file
 *  @copyright defined in slt/LICENSE.txt
 */
#include "help_text.hpp"
#include "localize.hpp"
#include <regex>
#include <fc/io/json.hpp>
#include <sltpos/chain/exceptions.hpp>

using namespace sltpos::client::localize;
using namespace sltpos::chain;
...
const char* history_plugin_advice_text = _("\033[32mPlease ensure that the \033[2msltpos::history_plugin\033[22m is enabled on the RPC node you are connecting to and that an account involved in this transaction was configured in the \033[2mfilter-on\033[22m setting.\033[0m\n");
...
const char* error_advice_public_key_type_exception = R"=====(Public key should be encoded in base58 and starts with SLT prefix)=====";
...
const char* error_advice_authority_type_exception = R"=====(Ensure that your authority JSON is valid follows the following format!
{
  ...
  "keys": [         <keys must be alpha-numerically sorted by their string representations and unique>
    ...
    {
      "key":        <STRING: SLTPOS compatible Public Key>,
...
You can refer to contracts/sltposlib/transaction.hpp for reference)=====";
...
const char* error_advice_tx_duplicate =  "You can try embedding sltpos nonce action inside your transaction to ensure uniqueness.";
...
const char* error_advice_missing_chain_api_plugin_exception =  "Ensure that you have \033[2msltpos::chain_api_plugin\033[0m\033[32m added to your node's configuration!";
const char* error_advice_missing_wallet_api_plugin_exception =  "Ensure that you have \033[2msltpos::wallet_api_plugin\033[0m\033[32m added to your node's configuration!\n"\
                                    "Otherwise specify your wallet location with \033[2m--wallet-url\033[0m\033[32m argument!";
const char* error_advice_missing_history_api_plugin_exception =  "Ensure that you have \033[2msltpos::history_api_plugin\033[0m\033[32m added to your node's configuration!";
const char* error_advice_missing_net_api_plugin_exception =  "Ensure that you have \033[2msltpos::net_api_plugin\033[0m\033[32m added to your node's configuration!";
...
namespace sltpos { namespace client { namespace help {

bool print_recognized_errors(const fc::exception& e, const bool verbose_errors) {
   // slt recognized error code is from 3000000
   // refer to libraries/chain/include/sltpos/chain/exceptions.hpp
